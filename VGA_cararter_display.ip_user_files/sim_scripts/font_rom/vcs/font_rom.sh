...
design_libs=(xpm dist_mem_gen_v8_0_17 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work dist_mem_gen_v8_0_17 $vlogan_opts +v2k +incdir+"../../../../../../../Vivado/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mariana/Desktop/project_2nd_Semester/processor/VGA_cararter_display.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key font_rom_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc font_rom_simv.daidir vcs_lib c.obj)
