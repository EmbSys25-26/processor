...
#
# Script generated by Vivado on Sat Mar 21 18:47:41 WET 2026
...
design_libs_elab="-libname xpm -libname dist_mem_gen_v8_0_17 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm dist_mem_gen_v8_0_17 xil_defaultlib)
...
compile()
{
  ...
  xmvlog -work dist_mem_gen_v8_0_17 $xmvlog_opts +incdir+"../../../../../../../Vivado/2025.1/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.font_rom xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.font_rom -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mariana/Desktop/project_2nd_Semester/processor/VGA_cararter_display.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log font_rom_sc.so .tmp_log xcelium_lib waves.shm c.obj)
