...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L dist_mem_gen_v8_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot font_rom xil_defaultlib.font_rom xil_defaultlib.glbl -log elaborate.log
}
