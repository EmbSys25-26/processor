...
HD_PWD='/home/mariana/Desktop/project_2nd_Semester/processor/VGA_cararter_display.runs/char_buffer_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log char_buffer_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source char_buffer_bram.tcl
