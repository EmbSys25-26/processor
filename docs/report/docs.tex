...
repo_root/
  srcs/                 # RTL: soc/cpu/control/datapath/bus/peripherals/BRAM
  constraints/          # XDC: board constraints + optional ILA insertion
  sim/                  # testbenches + wave configs
  assembly/             # assembly programs + vector table
  tools/abi.inc         # ABI aliases/macros
  tools/assembler.py    # assembler + preprocessor
  scripts/ci/           # CI simulation regression runner
