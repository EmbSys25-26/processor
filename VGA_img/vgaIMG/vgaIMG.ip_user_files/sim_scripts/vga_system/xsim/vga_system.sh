...
export RDI_DATADIR="/home/mariana/Vivado/2025.1/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L fifo_generator_v13_2_13 -L axi_datamover_v5_1_37 -L axi_vdma_v6_3_23 -L xlconstant_v1_1_10 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_35 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vga_system xil_defaultlib.vga_system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vga_system -key {Behavioral:sim_1:Functional:vga_system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_654d.protoinst" -protoinst "protoinst_files/bd_ead3.protoinst" -protoinst "protoinst_files/vga_system.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mariana/Vivado/2025.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vga_system.wdb xsim.dir libdpi.so)
