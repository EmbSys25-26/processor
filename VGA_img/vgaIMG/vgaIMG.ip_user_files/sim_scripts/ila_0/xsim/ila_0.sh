...
simulate()
{
  xsim ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_654d.protoinst" -protoinst "protoinst_files/bd_ead3.protoinst" -protoinst "protoinst_files/vga_system.protoinst" -log simulate.log
}
