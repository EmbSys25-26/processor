...
module periph_bus(
    ...
    (* mark_debug = "true" *) output wire [15:0] o_rdata,         // Data Read
    ...
    input  wire        i_clkVGA,         // 25.175 MHz vindo do clk_wiz para o VGA
 ...
 ***************************************************************************/
    ...
    wire _sel_vga;      // Ativa o VGA
    wire _vga_rdy;      // Resposta de pronto do VGA
    wire [15:0] _vga_rdata;

    // Fios da "ponte" entre Teclado e Vídeo
    wire [7:0] _ps2_rx_data;    // Byte bruto do teclado
    wire       _ps2_rx_valid;   // Validação do byte
    wire [7:0] _ascii_code;     // Letra convertida
    wire       _ascii_valid;    // Validação da letra
 ...
 ***************************************************************************/
    ...
    // converte Scancode em ASCII SCANCODE VEM DO PS/2 que vai para o VGA em ASCII
