 ...
 ************************************************************************************/
    ...
    wire        _DDR_reset_n;
    wire        _DDR_we_n;
    wire        _FIXED_IO_ddr_vrn;
    wire        _FIXED_IO_ddr_vrp;
    wire [53:0] _FIXED_IO_mio;
    wire        _FIXED_IO_ps_clk;
    wire        _FIXED_IO_ps_porb;
    wire        _FIXED_IO_ps_srstb;
 ...
 ************************************************************************************/
    soc dut (
        ...
        .io_i2c_sda(_i2c_sda),
        .io_i2c_scl(_i2c_scl),
        .i_mode_switch(_mode_switch),
        .io_DDR_addr(_DDR_addr),
        .io_DDR_ba(_DDR_ba),
        .io_DDR_cas_n(_DDR_cas_n),
        .io_DDR_ck_n(_DDR_ck_n),
        .io_DDR_ck_p(_DDR_ck_p),
        .io_DDR_cke(_DDR_cke),
        .io_DDR_cs_n(_DDR_cs_n),
        .io_DDR_dm(_DDR_dm),
        .io_DDR_dq(_DDR_dq),
        .io_DDR_dqs_n(_DDR_dqs_n),
        .io_DDR_dqs_p(_DDR_dqs_p),
        .io_DDR_odt(_DDR_odt),
        .io_DDR_ras_n(_DDR_ras_n),
        .io_DDR_reset_n(_DDR_reset_n),
        .io_DDR_we_n(_DDR_we_n),
        .io_FIXED_IO_ddr_vrn(_FIXED_IO_ddr_vrn),
        .io_FIXED_IO_ddr_vrp(_FIXED_IO_ddr_vrp),
        .io_FIXED_IO_mio(_FIXED_IO_mio),
        .io_FIXED_IO_ps_clk(_FIXED_IO_ps_clk),
        .io_FIXED_IO_ps_porb(_FIXED_IO_ps_porb),
        .io_FIXED_IO_ps_srstb(_FIXED_IO_ps_srstb)
    );
