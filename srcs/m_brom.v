...
`else
        $readmemh("/home/armeiro/Documents/projeto_processor/processor-pipeline-dynamic-branch-predictor/srcs/mem/mem_lo.hex", _mem_l);
        $readmemh("/home/armeiro/Documents/projeto_processor/processor-pipeline-dynamic-branch-predictor/srcs/mem/mem_hi.hex", _mem_h);
`endif
    end
/*************************************************************************************
