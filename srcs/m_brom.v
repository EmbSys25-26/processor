...
`else
        $readmemh("/home/rusbini25/2Semester/pipeline/processor/srcs/mem/mem_lo.hex", _mem_l);
        $readmemh("/home/rusbini25/2Semester/pipeline/processor/srcs/mem/mem_hi.hex", _mem_h);
`endif
    end
/*************************************************************************************
