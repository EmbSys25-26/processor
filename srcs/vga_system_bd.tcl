...
################################################################
# This is a generated script based on design: vga_system
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.FREQ_HZ {25173611} \
   ] $M_AXIS_MM2S_0

  set i_sw_gpio [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 i_sw_gpio ]


  # Create ports
  set sys_clock [ create_bd_port -dir I -type clk -freq_hz 25173611 sys_clock ]
  set_property -dict [ list \
   CONFIG.PHASE {0.0} \
 ] $sys_clock
...
\
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports i_sw_gpio] [get_bd_intf_pins axi_gpio_1/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXIS_MM2S [get_bd_intf_ports M_AXIS_MM2S_0] [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S]
  ...
  connect_bd_net -net clk_wiz_0_clk_pixel  [get_bd_ports sys_clock] \
  [get_bd_ports clk_pixel_0] \
