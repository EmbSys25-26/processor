...
main:
    ...
    ; expected: t1 = 7 & 7 = 7
    ; ============================
    LW   t0, sp, #0             ; [4|4|D|0] = 0x44D0  (t0 = MEM[sp+0] = 7)                                            | MEM_ADDR = 0x0114
    AND  t1, t0                 ; [2|5|4|2] = 0x2542  (t1 = t1 & t0 — load-use: 0 gap → 2 stalls)                    | MEM_ADDR = 0x0116
    ...
    ADDI s0, s0, #0             ; [1|8|8|0] = 0x1880  (gap: independent, absorbs 1 stall cycle)                       | MEM_ADDR = 0x011A
    AND  t1, t0                 ; [2|5|4|2] = 0x2542  (t1 = t1 & t0 — load-use: 1 gap → 1 stall)                     | MEM_ADDR = 0x011C

    ; ============================
    ; TEST 3: load-use with 2 gaps — 0 stalls expected
    ; 2 independent instructions fully hide the 2-cycle memory latency
    ; expected: t1 = 7 & 7 = 7
    ; ============================
    LW   t0, sp, #0             ; [4|4|D|0] = 0x44D0  (t0 = MEM[sp+0] = 7)                                            | MEM_ADDR = 0x011E
    ADDI s0, s0, #0             ; [1|8|8|0] = 0x1880  (gap 1: independent, absorbs stall cycle 1)                     | MEM_ADDR = 0x0120
    ADDI s1, s1, #0             ; [1|9|9|0] = 0x1990  (gap 2: independent, absorbs stall cycle 2)                     | MEM_ADDR = 0x0122
    AND  t1, t0                 ; [2|5|4|2] = 0x2542  (t1 = t1 & t0 — no stall, latency fully hidden)                 | MEM_ADDR = 0x0124
    ...
    ; expected: t2 = 7 + 3 = 10
    ; ============================
    LW   t0, sp, #0             ; [4|4|D|0] = 0x44D0  (t0 = MEM[sp+0] = 7)                                            | MEM_ADDR = 0x0126
    AND  t2, t0                 ; [2|6|4|2] = 0x2642  (t2 = t2 & t0 = 7 — load-use: 0 gap → 2 stalls)                | MEM_ADDR = 0x0128
    LW   t1, sp, #1             ; [4|5|D|1] = 0x45D1  (t1 = MEM[sp+1] = 3)                                            | MEM_ADDR = 0x012A
    ADD  t2, t1                 ; [2|6|5|0] = 0x2650  (t2 = t2+t1 = 7+3 = 10 — load-use: 0 gap → 2 stalls)           | MEM_ADDR = 0x012C
    ...
    ; expected: MEM[sp+2] = 7
    ; ============================
    LW   t0, sp, #0             ; [4|4|D|0] = 0x44D0  (t0 = MEM[sp+0] = 7)                                            | MEM_ADDR = 0x012E
    SW   t0, sp, #2             ; [6|4|D|2] = 0x64D2  (MEM[sp+2] = t0 = 7 — load-use: 0 gap → 2 stalls)              | MEM_ADDR = 0x0130
