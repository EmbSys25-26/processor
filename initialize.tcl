...
# --- Bitstream ---
set bitstream_file [find_file_recursive $script_dir "*.bit" 4]
...
set ps7_init_file [find_file_recursive $script_dir "ps7_init.tcl" 4]

if {$ps7_init_file eq ""} {
    set xsa_file [find_file_recursive $script_dir "*.xsa" 3]
    if {$xsa_file ne ""} {
